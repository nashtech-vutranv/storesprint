...
describe('Edit Marketplace Relationship Page', () => {
  beforeEach(() => {
    jest.mock('react-router-dom', () => {
      return {
        ...jest.requireActual('react-router-dom'),
        useParams: () => ({marketplaceRelationshipsId: 'test_mrk_id'}),
      }
    })
  ...
  it('should match snapshot with data from api', async () => {
    jest
      ...
      .mockImplementation((relationshipsData) => {
        conditionPromise(relationshipsData, 'marketplaceRelationship')
      })
    ...
    const siteSelect = tree.container.querySelector('#siteId') as Element
